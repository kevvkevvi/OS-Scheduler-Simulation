...
extern int thread_lock(unsigned lock);
extern int thread_unlock(unsigned lock);
extern int thread_wait(unsigned lock, unsigned cond);
extern int thread_signal(unsigned lock, unsigned cond);
extern int thread_broadcast(unsigned lock, unsigned cond);
